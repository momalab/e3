/*
This program takes a packed ciphertext as input and returns a packed 
ciphertext with the fibonacci number for each value in the input
*/
#include <iostream>
#include <vector>
...
//Function to find the nth fibonacci number given input n
template <class T>
...
{
    SecureInt input = _7_6_5_4_3_2_0_Ep;
    Timer t;
...
int main()
{
    tmain<SecureMint>("SecureMint", _0_Ea, _1_1_1_1_1_1_Ea);
}
